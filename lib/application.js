...
export default class Application {
    constructor({ plugins = null, resources = null} = {}) {
     ...
     */
    resources(resources) {
        this._ioc.registerAll(resources);
    ...
    module(module) {
        ...
        this._modules.set(name, new ModuleManager(this, module, this._pluginsManager));
    ...
    _getInitializedModule(module, name) {
        ...
        if (!module.isInitialized()) {
            ...
            module.init(this._ioc, ...depsModules);
